...
namespace SucculentShop.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            ViewBag.RoleId = new SelectList(db.Roles, "RoleId", "RoleTittle");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,RoleId,UserName,Password,Email,ActiveCode,IsActive,RegisterDate")] User user)
        {
            if (ModelState.IsValid)
            {
